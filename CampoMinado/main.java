...
public class main {
    ...
    public static void iniciarPartida(Jogador jogadorLogado) {
        ...
        do {
            ...
            try {
                ...
                int a = Integer.parseInt(s.nextLine());  // 1 ou 2
        ...
        if (venceu) {
            ...
            if (jogadorLogado.tentaBaterRecorde(tempoSegundos)) {
    ...
    public static void top10(){
        ...
        for(Recorde r : rankingTop10){
            System.out.println(posicao + "º Lugar: " + r.getApelido() + " - " + r.getTempo() + " segundos"););
            posicao++;
        }
        System.out.println("---------------------------------");
    }
